...
const Navbar = () => {
  const {isauth,logout,data} = useContext(AuthContext)
  return (
 ...
 <div style={{display:"grid", gridTemplateColumns:"60% 40%",marginTop:"20px"}} ><div>  <img src="https://www.mytheresa.com/skin/frontend/mytheresa/default/images/logo-s.png?v=20221102T163423"  alt="https://www.mytheresa.com/skin/frontend/mytheresa/default/images/logo-s.png?v=20221102T163423"/> </div> <div> <Link className='texts'  to="/ShoppingBag">  <h3 style={{marginTop:"-1%"}}>Shopping bag</h3> </Link></div></div>
